  ...
  return (
    ...
    >
      <div className="ios-card-large ios-relative ios-overflow-hidden">
        ...
        <div className="ios-absolute ios-inset-0 ios-bg-gradient-to-br ios-from-system-purple/5 ios-to-primary-500/5" />
        
        <div className="ios-relative ios-z-10 ios-text-center ios-pb-6">
          <div className="ios-w-16 ios-h-16 ios-bg-gradient-to-r ios-from-system-purple ios-to-primary-500 ios-rounded-2xl ios-flex ios-items-center ios-justify-center ios-mx-auto ios-mb-4">
        ...
        <div className="ios-relative ios-z-10 ios-space-y-6">
          ...
          <form onSubmit={handleSubmit} className="ios-space-y-4">
            <div className="ios-space-y-2">
              <label htmlFor="name" className="ios-block ios-text-sm ios-font-medium ios-text-base-700 dark:ios-text-base-dark-300">
                Nombre Completo
              </label>
              <div className="ios-relative">
                <UserIcon className="ios-absolute ios-left-3 ios-top-1/2 ios-transform -ios-translate-y-1/2 ios-w-5 ios-h-5 ios-text-base-400" />
                <input
                  type="text"
                  id="name"
                  value={name}
            ...
            <div className="ios-space-y-2">
              <label htmlFor="confirmPassword" className="ios-block ios-text-sm ios-font-medium ios-text-base-700 dark:ios-text-base-dark-300">
