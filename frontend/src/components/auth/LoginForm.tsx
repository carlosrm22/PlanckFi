...
export const LoginForm: React.FC<LoginFormProps> = ({ onSwitchToRegister }) => {
  ...
  const { login, loginWithGoogle, loading, error, clearError } = useAuthContext();
  ...
  return (
    ...
    >
      <Card variant="glass" className="relative overflow-hidden">
        ...
        <div className="absolute inset-0 bg-gradient-to-br from-primary-500/5 to-accentA-500/5" />
